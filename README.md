...
**Server Repo:** `https://github.com/your-username/recipehub-server`  
**Live API:** `https://your-server-url.onrender.com`
...
```bash
git clone https://github.com/your-username/recipehub-client
cd recipehub-client
npm install
npm run dev
